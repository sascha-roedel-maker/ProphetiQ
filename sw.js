const CACHE='qulora-v11-3-3-2-multi-pdf-stability-fix';
...
self.addEventListener('fetch',event=>{
  ...
  const fresh=event.request.mode==='navigate'||url.pathname.endsWith('/index.html')||url.pathname.endsWith('/trend-data.json')||url.pathname.endsWith('/web-ranking-data.json');
